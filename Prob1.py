...
def draw_image():
    ...
    rectangle(0,0,350,h//2.005,"White")           
    rectangle(0,0,350,h//2.005,"Blue")            
    rect_rotate(20,-18,350,h//8.5,"White",-30)    
    rect_rotate(0,175,350,h//8.5,"White",30)      
    ...
    rect_rotate(0,200,200,h//25,"Red",30)     
    rect_rotate(0,-3,200,h//25,"Red",-30)
    rect_rotate(147,100,250,h//25,"Red",30)
    rect_rotate(175,83,250,h//25,"Red",-30)
    rectangle(350,150,450,h//8.15,"White")
    
    rectangle(0,65,350,h//5.45,"White")           # Two white cross stripes
    rectangle(137.5,0,w//10.75,h//2.005,"White")
    rectangle(0,77.5,350,h//8.5,"Red")            # Two red cross strips
